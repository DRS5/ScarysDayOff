...
public class Screen {
    ...
    public void createIntroScreen(){
        screen = new Picture(10, 10, "resources/screens/intro screen s q.png");
        screen.draw();
    ...
    public void createGameOverScreen(){
        Picture gameOverScreen = new Picture(10, 10, "resources/screens/game over.png");
        gameOverScreen.draw();
    }

    public void createVictoryScreen(){
        Picture victoryScreen = new Picture(10, 10, "resources/screens/congratulations.png");
        victoryScreen.draw();
    }

    public void createTutorialScreen() throws InterruptedException {
        Picture tutorialScreen = new Picture(10, 10, "resources/screens/tutorial com quit.png");
        tutorialScreen.draw();
        Thread.sleep(8000);
